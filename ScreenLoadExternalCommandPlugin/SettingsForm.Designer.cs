...
namespace ExternalCommand {
	partial class SettingsForm {
		...
		private void InitializeComponent() {
			...
			this.button_new = new ScreenLoadPlugin.Controls.ScreenLoadButton();
			this.button_delete = new ScreenLoadPlugin.Controls.ScreenLoadButton();
			this.button_edit = new ScreenLoadPlugin.Controls.ScreenLoadButton();
			this.SuspendLayout();
			// 
			// buttonCancel
			// 
		...
		private ScreenLoadPlugin.Controls.ScreenLoadButton button_edit;
		private ScreenLoadPlugin.Controls.ScreenLoadButton button_delete;
		private ScreenLoadPlugin.Controls.ScreenLoadButton button_new;
