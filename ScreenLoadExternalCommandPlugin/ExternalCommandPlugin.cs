...
namespace ExternalCommand {
	...
	/// </summary>
	public class ExternalCommandPlugin : IScreenLoadPlugin {
		...
		/// <summary>
		/// Implementation of the IScreenLoadPlugin.Initialize
		/// </summary>
		/// <param name="pluginHost">Use the IScreenLoadPluginHost interface to register events</param>
