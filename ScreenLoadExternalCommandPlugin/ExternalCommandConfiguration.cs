...
namespace ExternalCommand {
	...
	/// </summary>
	[IniSection("ExternalCommand", Description="ScreenLoad ExternalCommand Plugin configuration")]
	public class ExternalCommandConfiguration : IniSection {
		...
		[IniProperty("RedirectStandardError", Description = "Redirect the standard error of all external commands, used to output as warning to the ScreenLoad.log.", DefaultValue = "true")]
		...
		[IniProperty("ShowStandardOutputInLog", Description = "Depends on 'RedirectStandardOutput': Show standard output of all external commands to the ScreenLoad log, this can be usefull for debugging.", DefaultValue = "false")]
