...
namespace ScreenLoadPlugin.Core {
	...
	public class OAuthSession {
		...
		private string _userAgent = "ScreenLoad";
		...
		public string CallbackUrl { get; set; } = "http://getScreenLoad_org";

		public bool CheckVerifier { get; set; } = true;

		public Size BrowserSize { get; set; } = new Size(864, 587);

		public string LoginTitle { get; set; } = "Authorize ScreenLoad access";
...
<body>
ScreenLoad received information from CloudServiceName. You can close this browser / tab if it is not closed itself...
