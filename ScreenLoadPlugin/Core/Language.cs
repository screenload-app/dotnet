	...
	public class Language {
		...
		static Language() {
			if (!IniConfig.IsInitialized) {
				...
				IniConfig.Init("ScreenLoad", "ScreenLoad");
			}
			...
			try {
				...
				{
					AddPath(Path.Combine(applicationFolder, @"App\ScreenLoad\Languages"));
				}
				// Application data path
				string applicationDataFolder = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
				AddPath(Path.Combine(applicationDataFolder, @"ScreenLoad\Languages\"));
