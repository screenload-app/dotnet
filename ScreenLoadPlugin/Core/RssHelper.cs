...
//		private const string Rssfeed = "https://download.ru/ScreenLoad/feed.xml";
...
//		/// <summary>
//		/// Read the ScreenLoad RSS feed, so we can use this information to check for updates
//		/// </summary>
...
//						continue;
//					}
//					Match match = Regex.Match(Uri.UnescapeDataString(link), @"^.*\/(ScreenLoad.+)\/download$");
//					if (!match.Success)
//					{
//						continue;
//					}
