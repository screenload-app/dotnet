...
namespace ScreenLoadPlugin.Controls
{
    ...
    /// </summary>
    public class AnimatingForm : ScreenLoadForm
    {
        ...
        /// </summary>
        protected bool IsTerminalServerSession => !coreConfiguration.DisableRDPOptimizing &&
                                                  (coreConfiguration.OptimizeForRDP ||
