...
namespace ScreenLoad.Helpers {
	...
	public static class StartupHelper {
		...
		private const string ApplicationName = "ScreenLoad";
		...
		/// </summary>
		/// <returns>true if ScreenLoad can write key</returns>
		...
		/// <summary>
		/// Return true if the local machine has a RUN entry for ScreenLoad
		/// </summary>
		...
		/// <summary>
		/// Return true if the current user has a RUN entry for ScreenLoad
		/// </summary>
		/// <returns>true if there is a run key</returns>
