    ...
    public class RegistryMonitor : IDisposable
    {
        ...
        private void ThreadLoop()
        {
            ...
            try
            {
                ...
                WaitHandle[] waitHandles = new WaitHandle[] { autoResetEvent, _eventTerminate };
                while (!_eventTerminate.WaitOne(0, true))
                {
#pragma warning disable 618
                    result = RegNotifyChangeKeyValue(registryKey, true, _regFilter, autoResetEvent.Handle, true);
