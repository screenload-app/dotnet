...
using ScreenLoad.Drawing.Fields;
...
namespace ScreenLoad.Configuration
{
    /// <summary>
    /// Description of CoreConfiguration.
    /// </summary>
    [IniSection("Editor", Description = "ScreenLoad editor configuration")]
    public class EditorConfiguration : IniSection
    {
        ...
        [IniProperty("LastFieldValue", Separator = "|",
        ...
        [IniProperty("MatchSizeToCapture", Description = "Match the editor window size to the capture",
            DefaultValue = "True")]
        ...
        [IniProperty("WindowNormalPosition", Description = "Position of normal window",
        ...
        [IniProperty("SuppressSaveDialogAtClose",
