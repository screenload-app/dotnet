...
namespace ScreenLoad {
	partial class ImageEditorForm {
		...
		private void InitializeComponent() {
			...
			this.arrowHeadsDropDownButton = new ScreenLoadPlugin.Controls.ScreenLoadToolStripDropDownButton();
		...
		private ScreenLoadPlugin.Controls.ScreenLoadToolStripDropDownButton arrowHeadsDropDownButton;
