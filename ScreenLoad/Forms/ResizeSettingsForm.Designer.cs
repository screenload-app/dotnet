...
namespace ScreenLoad.Forms {
	partial class ResizeSettingsForm {
		...
		private void InitializeComponent() {
            ...
            this.checkbox_aspectratio = new ScreenLoadPlugin.Controls.ScreenLoadCheckBox();
            this.label_width = new ScreenLoadPlugin.Controls.ScreenLoadLabel();
            this.label_height = new ScreenLoadPlugin.Controls.ScreenLoadLabel();
