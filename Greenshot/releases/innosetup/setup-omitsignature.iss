...
#define FileVersion "1.6.1.0-local"
...
;DownloadRu Plugin
Source: ..\..\bin\Release\Plugins\GreenshotDownloadRuPlugin\GreenshotDownloadRuPlugin.gsp; DestDir: {app}\Plugins\GreenshotDownloadRuPlugin; Components: plugins\downloadru; Flags: overwritereadonly recursesubdirs ignoreversion replacesameversion;
Source: ..\..\bin\Release\Languages\Plugins\GreenshotDownloadRuPlugin\*; DestDir: {app}\Languages\Plugins\GreenshotDownloadRuPlugin; Components: plugins\downloadru; Flags: overwritereadonly ignoreversion replacesameversion;
